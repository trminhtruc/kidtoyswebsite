...
<script src="resources/js/3.5.1/jquery.min.js"></script>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="product-detail-img">
					<img src="resources/${dochoi.hinhAnhURL}">
				</div>
			</div>
			<div class="col-md-8">
				<form action="CartController" method="post">
					<div class="info-content">
						<div class="pro-title">
							<h3 class="product-name">${dochoi.tenDoChoi}</h3>
						</div>
						<div class="pro-price">
							<strong class="product-price">${dochoi.giatien}</strong>
						</div>
						<div class="pro-des">
							<strong>Mô tả:</strong>
							<p class="product-des">${dochoi.moTa}</p>
						</div>
						<div class="pro-quantity">

							<strong>Số lượng</strong> <input type="text" maxlength="4"
								required="required"
								onkeyup="this.value=this.value.replace(/[^\d]/,'')"
								name="soLuong" class="form-control" style="width: 40px"
								value="1" />
							<!-- SO LUONG CHON MUA -->
